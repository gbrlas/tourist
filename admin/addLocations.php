...
<head>
    ...
    <title>TRAVEL TIME ADMIN - Dodavanje lokacija</title>
        ...
        <div class="col-md-5">
            <h4>
                ...
                if (isset($_POST['saveForm'])) {
                    ...
                    $upit = "INSERT INTO lokacija (ime, opis, tip, idDrzava) VALUES ($name, $description, $type, $state)";
                    mysqli_query ($veza, $upit) or die (mysqli_error($veza));
                    echo "
                    <div class=\"col-md-6\">
                        <h4>Lokacija uspješno dodana:</h4>
                    $name <br>
                    $description <br>
                    $type <br>
                    $state <br>
