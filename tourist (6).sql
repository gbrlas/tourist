...
--
-- Računalo: localhost
-- Vrijeme generiranja: May 27, 2016 u 12:14 PM
...
CREATE TABLE IF NOT EXISTS `soba_rezervacija` (
  ...
  KEY `idSoba` (`idSoba`),
  KEY `idSoba_2` (`idSoba`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin AUTO_INCREMENT=78 ;
